					...
					if (Model.isTheCategoryExist(categoryName)) {
						...
						while (choice2 != 6) {
							...
							case 1:
								...
								System.out.println("Enter the tags of the task...comma seperated[ex:daily,morning,etc....]");
									...
									if (Model.checkIfTaskExists(category, taskName)) {
										...
										while (choice3 != 6) {
											...
											case 3:
												...
												System.out.println("Enter the new tags of the task...comma seperated[ex:daily,morning,etc....]");
											...
											case 4:
												...
												System.out.println("Enter the new planned date the task to be completed");
												System.out.println("enter the date like this [yyyy-MM-dd]");
												date = sc2.nextLine();
												while (!TaskUtil.validateDate(date)) {
